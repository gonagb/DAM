<link rel="stylesheet" href="css/estilocontrolador.css">
    ...
    class Supercontrolador {
        ...
        function leer($tabla){
            ...
            while($fila = $resultado->fetch_assoc()){
                ...
                // Verificar si la propiedad "titulo" está presente antes de intentar acceder a ella
                if (isset($commentData->titulo)) {
                    echo '<th>' . $commentData->titulo . '</th>';
                } else {
                    echo '<th> </th>'; 
                }
            ...
            while($fila = $resultado->fetch_assoc()){
                echo '<th><input type="text" name="'.$fila["Field"].'" class="campobuscador"><img src="../bootstrap-icons-1.11.3/search.svg" class="iconobusca"></th>';
            ...
            while($fila = $resultado->fetch_assoc()){
                ...
                echo '<td>';
                echo '<a href="?tabla='.$_GET['tabla'].'&informe='.$fila['Identificador'].'"><img src="../bootstrap-icons-1.11.3/file-earmark-text.svg" class="icon"></a>';
                echo '<a href="?tabla='.$_GET['tabla'].'&update='.$fila['Identificador'].'"><img src="../bootstrap-icons-1.11.3/pencil-square.svg" class="icon"></a>';
                echo '<a href="?tabla='.$_GET['tabla'].'&delete='.$fila['Identificador'].'"><img src="../bootstrap-icons-1.11.3/trash3.svg" class="icon"></a>';
                echo '</td>';
                echo '</tr>';
            ...
            echo '</table>';
            echo '<a href="?create='.$_GET['tabla'].'" id="create"><img src="../bootstrap-icons-1.11.3/plus-circle.svg" class="icon"></a>';
            //iconos para la paginacion
            echo '<div class = "paginacion">
                <a href="?tabla='.$_GET['tabla'].'&pagina=primera"><img src = "../bootstrap-icons-1.11.3/skip-backward-fill.svg" class="icon"></a>
            
                <a href="?tabla='.$_GET['tabla'].'&pagina=anterior"><img src = "../bootstrap-icons-1.11.3/arrow-left-circle-fill.svg" class="icon"></a>
                <a href="?tabla='.$_GET['tabla'].'&pagina=siguiente"><img src = "../bootstrap-icons-1.11.3/arrow-right-circle-fill.svg" class="icon"></a>
                
                <a href="?tabla='.$_GET['tabla'].'&pagina=ultima"><img src = "../bootstrap-icons-1.11.3/skip-forward-fill.svg" class="icon"></a>
            </div>';
        }
